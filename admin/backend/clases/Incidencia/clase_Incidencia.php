	...
	class Incidencia{
		...
		public function getIncidencias(){
			try{
				...
				$resultadoMetodo = array();
				$resultadoConsulta = $this->conn->query("SELECT * FROM INCIDENCIAS INNER JOIN USUARIOS ON USUARIOS.id = INCIDENCIAS.id_usuario");
		...
		public function insertarIncidencia($descripcion, $idUsuario){
